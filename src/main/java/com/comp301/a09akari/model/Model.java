...
public interface Model {
   ...
   */
  void addLamp(int r, int c) throws FileNotFoundException;
   ...
   */
  void removeLamp(int r, int c) throws FileNotFoundException;
   ...
   */
  void setActivePuzzleIndex(int index) throws FileNotFoundException;
  ...
  void resetPuzzle() throws FileNotFoundException;
